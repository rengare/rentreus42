...
keyboard.keymap = [
    [
        ...
        ESC,  TAB,  SUPER, SHIFT, SPACE,                     CTRL,       BACK, L1,   RALT,    KC.QUOTE,  ENTER,  
    ],
    [
        ...
        TRANS, L2, TRANS, TRANS, TRANS,                      TRANS,      L2,       L0,    KC.DOT,  KC.N0,   KC.EQUAL, 
    ],
    [
        ...
        TRANS, L0, TRANS, TRANS, TRANS,                     TRANS,      L1,        L0,    ___, ___, ENTER,  
    ],
]
